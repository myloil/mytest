...
public class DesUtil {
	...
	/** 字符串默认键值 */
	private static String strDefaultKey = "shuaiyang8";
	/** 加密工具 */
	...
	public static void main(String[] args) {
		try {
			...
			String test2 = "Shuaiyang8";
			DesUtil des2 = new DesUtil("shuaiyang8");// 自定义密钥
